...
export const updateUser = async (req, res) => {
    try {
        connect()
        query('UPDATE users SET lastname=$1, firstname=$2, email=$3, password=$4, profile_image=$5, phone_number=$6, google_id=$7, access_level=$8,  gender=$9 WHERE user_id=$10',
            [req.body.lastname, req.body.firstname, req.body.email, req.body.password, req.body.profile_image, req.body.phone_number, req.body.google_id, req.body.access_level,req.body.gender, req.params.user_id], (result) => {
                res.writeHead(HTTP_OK, { 'Content-Type': CONTENT_TYPE_JSON })
